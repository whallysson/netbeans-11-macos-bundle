...
NETBEANS_VERSION=${NETBEANS_VERSION:-11}
NETBEANS_URI=${NETBEANS_URI:-http://mirror.nbtelecom.com.br/apache/incubator/netbeans/incubating-netbeans/incubating-11.0/incubating-netbeans-11.0-bin.zip}
